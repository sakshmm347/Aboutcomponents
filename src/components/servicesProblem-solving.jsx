...
const ServicesProblem = () => {
  return (
    <section className="text-white px-10 py-32" style={{ backgroundColor: "#000000" }}>
      ...
      {/* Image Flexbox Grid */}
       <div className="flex flex-col md:flex-row min-h-[500px] w-[1300px] mx-auto bg-black text-white gap-5 ">
  {/* Left Text Box */}
  ...
  {/* Image Box */}
  <div className="flex w-[350px] md:w-[600px] overflow-hidden rounded-lg ">
    <img
